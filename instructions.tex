...
It might also be interresting to send some status of the GPIO, which is what is done here in the \verb|sprintf| function.\\
...
\section{=TODO= Adding a swap partition}
\label{sec:adding-swap-part}
