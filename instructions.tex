...
As an extra proof that we correctly deployed the ``pingpong'' app on the Nucleo board, and in order to get used to modifying micro_ROS app, we made the pinging tasks also toggling LEDs on the board.\\
